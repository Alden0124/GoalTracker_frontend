...
import GoalFeed from "@/components/Feed/components/GoalFeed";
...
const Feed = () => {
  ...
  return (
    <div className="flex w-[95%] flex-col items-center py-[20px] m-[0_auto] max-w-[1440px] 
      md:px-[10px] md:gap-[20px] md:flex-row md:w-full md:items-start">
      {/* 桌面版側邊欄 */}
      <div className={`hidden md:flex flex-col md:w-[40%] lg:w-[30%] gap-4 sticky top-[64px]`}>
        <Following />
        <RecommendUsers />
      </div>
      ...
      <div className="w-full md:w-[60%] lg:w-[70%] flex flex-col gap-4">
        ...
        <MobileActions />
        <GoalFeed searchKeyword={searchKeyword} />
      </div>
    </div>
  );
};
